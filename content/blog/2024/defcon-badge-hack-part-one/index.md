...
Using a multimeter to check what these pads could be used for it looks like there is a common 5 volt rail that once connected to the other side lights up the LED.
