...
{{< image src="images/mcp3008-ic.jpg" width="150x" height="200x" class="is-pulled-right" title="">}}
...
{{< image src="images/adc_prototype.jpg" width="150x" height="200x" class="is-pulled-right" title="">}}
...
{{< image src="images/adc_prototype_sensor.jpg" width="150x" height="200x" class="is-pulled-right" title="">}}
...
{{< image src="images/PCBLayoutKiCAD.jpg" width="150x" height="200x" class="is-pulled-right" title="">}}

The KiCAD rendering suggested it should be ok once created with all the parts

{{< image src="images/pcb_render_kicad.jpg" width="150x" height="200x" class="is-pulled-right" title="">}}
